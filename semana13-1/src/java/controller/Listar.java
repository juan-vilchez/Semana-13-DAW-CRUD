...
public class Listar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Productos> px = productosFacade.findAll();
...
"  </thead>");                  
          ...
          for (Productos prod:px){
           
           sal.println("<tbody class=\"thead-light text-center\">\n<tr>\n");
           sal.println("<th scope=\"row\">"+ prod.getCodigo()+ "</th>\n" );
           sal.println("<td>"+ prod.getNombre()+ "</td>\n");
           sal.println("<td>"+ prod.getPrecio()+ "</td>\n");
           sal.println("<td>"+prod.getCantidad()+ "</td>\n");
